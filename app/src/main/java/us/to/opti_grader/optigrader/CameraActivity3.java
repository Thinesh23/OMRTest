...
import us.to.opti_grader.optigrader.utils.ImagePreprocessor;
import us.to.opti_grader.optigrader.utils.Constants;
import us.to.opti_grader.optigrader.utils.FolderUtil;
import us.to.opti_grader.optigrader.utils.Utilities;

public class CameraActivity3 extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        takePictureBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(CameraActivity3.this, "Picture has been taken ", Toast.LENGTH_LONG).show();
