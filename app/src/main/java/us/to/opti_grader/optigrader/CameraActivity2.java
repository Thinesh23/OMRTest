...
import us.to.opti_grader.optigrader.ProcessOMRSheetAsyncTask;
import us.to.opti_grader.optigrader.R;
import us.to.opti_grader.optigrader.Model.OMRSheet;
import us.to.opti_grader.optigrader.Model.OMRSheetViewModelFactory;
...
import us.to.opti_grader.optigrader.utils.PrereqChecks;
...
public class CameraActivity2 extends AppCompatActivity implements
    ...
    private void loadCorrectAnswers(){
        ...
        totalQuest = getIntent().getIntExtra("noOfAnswers",20);
            ...
            protected Void doInBackground(Void... voids) {
                if (db.omrKeyDao().findById(1) != null) {
                    ...
                    if (strCorrectAnswers[0] != null && !strCorrectAnswers[0].isEmpty()) {
                        ...
                        omrSheet.setNumberOfQuestions(totalQuest);
    ...
    protected void onResume() {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA)
            ...
            CameraActivity2.ConfirmationDialogFragment
...
/*            if(isBlurry || hasLowBrightness) {
        ...
        public void displayToast(final String toastMessage, final int duration){
            CameraActivity2.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    final Toast t = Toast.makeText(CameraActivity2.this,toastMessage,Toast.LENGTH_SHORT);
                    t.show();
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public static CameraActivity2.ConfirmationDialogFragment newInstance(@StringRes int message,
                                                                            String[] permissions, int requestCode, @StringRes int notGrantedMessage) {
            CameraActivity2.ConfirmationDialogFragment
                    fragment = new CameraActivity2.ConfirmationDialogFragment();
